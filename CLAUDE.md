...
| 前端 | `index.html` |
| 後端 | `Code.gs` |
| 內部版號 | ver5.5（2026-08-28 10~11月人力崗位變更，12月自動恢復：D欄支援→掛號2週四+週五／注射2加排週四+週五／週五全面比照週四(排班+正名+計數併週四桶)／每欄每日別上限2→3；唯一開關 OCTNOV_SPECIAL_YMS。另推播 v6.4 天氣重試3次+ScriptProperties日期感知備援；修 runAutoSchedule 非覆蓋模式 dow_ex 作用域 ReferenceError） |
